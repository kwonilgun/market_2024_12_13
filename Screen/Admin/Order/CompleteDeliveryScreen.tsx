...
import { CompleteDeliveryScreenProps} from '../../model/types/TAdminOrderNavigator';
...
import { COMPLETE_DELIVERY } from '../../../assets/common/BaseValue';
import { AdminExpandable } from '../../Orders/AdminExpandable';


const CompleteDeliveryScreen: React.FC<CompleteDeliveryScreenProps> = props => {
  ...
  const checkOrderStatus = async () => {
    ...
    //2025-01-31 10:47:59, 접수된 주문 필터링
      const filteredOrders = orders.filter(order => order.status === COMPLETE_DELIVERY);
          ...
          <ScrollView>
              <View style={styles.listContainer}>
                ...
                {dataList ? (
                  ...
                  <Text style={{textAlign: 'center'}}> 배송완료 정보 없음</Text>
                )}
              </View>
            </ScrollView>
        </KeyboardAvoidingView>
