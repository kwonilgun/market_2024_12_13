...
import {CompleteReturnScreenProps} from '../../model/types/TAdminOrderNavigator';
...
import {COMPLETE_RETURN } from '../../../assets/common/BaseValue';
import { AdminExpandable } from '../../Orders/AdminExpandable';


const CompleteReturnScreen: React.FC<CompleteReturnScreenProps> = props => {
  ...
  const checkOrderStatus = async () => {
    ...
    //2025-01-31 10:47:59, 접수된 주문 필터링
      const filteredOrders = orders.filter(order => order.status === COMPLETE_RETURN);
          ...
          <ScrollView>
              <View style={styles.listContainer}>
                ...
                {dataList ? (
                  ...
                  <Text style={{textAlign: 'center'}}> 반품완료 정보 없음</Text>
                )}
              </View>
            </ScrollView>
        </KeyboardAvoidingView>
...
export default CompleteReturnScreen;
