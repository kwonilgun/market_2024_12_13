...
import { DuringDeliveryScreenProps } from '../../model/types/TAdminOrderNavigator';
...
import { DURING_DELIVERY, PREPARE_DELIVERY } from '../../../assets/common/BaseValue';
import { AdminExpandable } from '../../Orders/AdminExpandable';


const DuringDeliveryScreen: React.FC<DuringDeliveryScreenProps> = props => {
  ...
  const checkOrderStatus = async () => {
    ...
    //2025-01-31 10:47:59, 접수된 주문 필터링
      const filteredOrders = orders.filter(order => order.status === DURING_DELIVERY);
          ...
          <ScrollView>
              <View style={styles.listContainer}>
                ...
                {dataList ? (
                  ...
                  <Text style={{textAlign: 'center'}}> 배송 중 정보 없음</Text>
                )}
              </View>
            </ScrollView>
        </KeyboardAvoidingView>
...
export default DuringDeliveryScreen;
