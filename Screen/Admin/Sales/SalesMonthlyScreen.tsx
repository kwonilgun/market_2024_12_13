...
import { SalesChartScreenProps, SalesMonthlyScreenProps } from '../../model/types/TSalesNavigator';
...
const SalesMonthlyScreen: React.FC<SalesMonthlyScreenProps> = props => {
  ...
  //   value: item.value, // Use 'value' for y-axis
  //   label: item.label, // Example: "Jan 01"
...
export default React.memo(SalesMonthlyScreen);